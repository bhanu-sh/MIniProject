  ...
  return (
    <div>
      ...
      <div className="container">
        <h2 className="text-center">What we Feature:</h2>
        <div className="row gx-5">
          <div className="col-md-4 py-2">
            <div className="shadow card p-3 tagline min-card">
              <img
      ...
      <div className="container mb-3">
        <div className="text-center">
          <h2 className="pb-3">Furnitures:</h2>
          <div className="row gx-5">
            <div className="col-md-3 py-2">
              <div className="card shadow">
                ...
                />
                <button
                  className="btn btn-primary mx-auto w-50 my-2"
          ...
          <Link to="/browse">
            <button className="btn btn-primary shadow m-2 p-2">All Products</button>
          </Link>
        </div>
      </div>
        <Footer />
