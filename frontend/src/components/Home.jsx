  ...
  const displayData = () => {
    return furnitureData.map((furniture) => (
      <div className="col-md-3 py-2">
        <div className="card">
          <img className="card img-resize img-fluid" src={furniture.image} alt="" />
    ...
    <div className="container">
      <div className="header text-center vh-100">
        ...
        <div className="py-5">
            ...
            <a href="#b0">
                <img className="img-fluid rounded mx-auto d-block" src="https://cdn-icons-png.flaticon.com/512/59/59690.png" width={100} alt="" />
            </a>
        </div>
